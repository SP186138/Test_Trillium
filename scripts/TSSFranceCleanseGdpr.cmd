...
set TSS_PROCESS=Gdpr
set T_SCRIPTS=E:\scripts
set TSS_PROJECTS=E:\projects
set ROUTER_WRK=E:\Gdpr\workarea_router
set US_WRK=E:\Gdpr\workarea1
set BRA_WRK=E:\Gdpr\workarea2
set LAT_WRK=E:\Gdpr\workarea3
set CAN_WRK=E:\Gdpr\workarea10
set ARG_WRK=E:\Gdpr\workarea18
set CHL_WRK=E:\Gdpr\workarea19
set MEX_WRK=E:\Gdpr\workarea20
set TRK_WRK=E:\Gdpr\workarea21
set ITA_WRK=E:\Gdpr\workarea_ITA
set GBR_WRK=E:\Gdpr\workarea_GBR
set GRC_WRK=E:\Gdpr\workarea_GRC
set ESP_WRK=E:\Gdpr\workarea_ESP
set FRA_WRK=E:\Gdpr\workarea_FRA
set LUX_WRK=E:\Gdpr\workarea_LUX
set HUN_WRK=E:\Gdpr\workarea_HUN
set RUS_WRK=E:\Gdpr\workarea_RUS
set POL_WRK=E:\Gdpr\workarea_POL
set DEU_WRK=E:\Gdpr\workarea_DEU
set AUT_WRK=E:\Gdpr\workarea_AUT
set CHE_WRK=E:\Gdpr\workarea_CHE
set NLD_WRK=E:\Gdpr\workarea_NLD
set BEL_WRK=E:\Gdpr\workarea_BEL
set DNK_WRK=E:\Gdpr\workarea_DNK
set SWE_WRK=E:\Gdpr\workarea_SWE
set NOR_WRK=E:\Gdpr\workarea_NOR
set FIN_WRK=E:\Gdpr\workarea_FIN
set IRL_WRK=E:\Gdpr\workarea_IRL
set PRT_WRK=E:\Gdpr\workarea_PRT
...
:: | File:     TSSFranceCleanse.cmd                                            |
:: | Purpose:  Cleanse 1CP France data.                                        |
:: +---------------------------------------------------------------------------+
:: |                                                                           |
...
:: |  ...........  .........  ...............................................  |
:: |  22-Apr-2013  sheldon    Created.                                         |
:: |  02-Jan-2014  sheldon    Upgraded to TSS v14.0.                           |
:: |  03-Jan-2014  sheldon    Added lat/long geocoder.                         |
:: |  13-Feb-2014  caleb      Inserted Transformer after CDP - for Tuning      |
:: |                                                                           |
:: +---------------------------------------------------------------------------+
   ...
   ::! @set TS_PROJECT=C:\Trillium_Development\v14\development\projects\FRA\cleanse
   ...
   @set TS_POSTAL=%TS_QUALITY%\..\tables
   @set TS_PROJECT=%TSS_PROJECTS%\FRA\cleanse
   @set TS_WORKAREA=%FRA_WRK%
   @set PATH=%TS_QUALITY%\bin;%SystemRoot%\system32;%SystemRoot%
   ...
   @if NOT EXIST "%TS_DATA%\TSS_CLEANSE_INPUT_FRA.DAT" (
      @echo FRA cleanse input file is missing.  No FRA cleansing performed. >>"%RUNLOG%"
      @type nul > "%TS_DATA%\TSS_CLEANSE_OUTPUT_FRA.DAT"
      @type nul > "%TS_DATA%\TSS_WINKEY_OUTPUT_FRA.DAT"
      @set status=0
      @goto end
   )
   ...
   ::            3. Transformer 2
   ::            4: Sort for Postal Matcher
   ::            5: Postal Matcher
   ::            6: Transformer 3 (data reconstructor)
   ::            7: Geocoder (lat/long)
   ::            8: Window Key Generator
   ::            9: Transformer 4 (output)
   ::
   ::    Reads:  TSS_CLEANSE_INPUT_FRA.DAT
   ::    Writes: TSS_CLEANSE_OUTPUT_FRA.DAT
   ::

   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\frtranfrmr_p1.stx"  "%TS_LOGS%\p1_frtranfrmr"  "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\cusparse"  "%TS_SETTINGS%\frcusparse_p2.stx"  "%TS_LOGS%\p2_frcusparse"  "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\frtranfrmr_p10.stx" "%TS_LOGS%\p10_frtranfrmr" "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tsqsort"   "%TS_SETTINGS%\frsrtforpm_p3.stx"  "%TS_LOGS%\p3_frsrtforpm"  "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tqpmatch"  "%TS_SETTINGS%\frpmatch_p4.stx"    "%TS_LOGS%\p4_frpmatch"    "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\frdrtrans_p5.stx"   "%TS_LOGS%\p5_frdrtrans"   "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\gllatlon"  "%TS_SETTINGS%\frlatlon_p9.stx"    "%TS_LOGS%\p9_frlatlon"    "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\winkey"    "%TS_SETTINGS%\frwinkey_p6.stx"    "%TS_LOGS%\p6_frwinkey"    "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\frtranfrmr_p7.stx"  "%TS_LOGS%\p7_frtranfrmr"  "%ERRLOG%"    ))))))))
   @call :check_status "p1,p2,p10,p3,p4,p5,p9,p6,p7" "Cleanse"
   ...
   ::    +---------------------------------------------------------------------+
   ::
   ::    Reads:  TSS_CLEANSE_OUTPUT_FRA.DAT
   ::    Writes: TSS_WINKEY_OUTPUT_FRA.DAT
   ::

   @call "%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\frtranfrmr_p8.stx"  "%TS_LOGS%\p8_frtranfrmr"  "%ERRLOG%"
   ...
   @if %status% == 0 (
      @echo.
      @echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      @echo TSSFranceCleanse job succeeded!
      @echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      @echo.
   ) else (
      @echo.
      @echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      @echo TSSFranceCleanse job failed!
      @echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      @if EXIST "%ERRLOG%" (
         @type "%ERRLOG%" 1>&2
      )
   ...
   @if "%TSS_PROCESS%" == "i2" (
copy %FRA_WRK%\data\TSS_WINKEY_OUTPUT_FRA.DAT %TSS_OUTPUT%\TSS_WINKEY_OUTPUT_FRA.DAT
)
