...
set TSS_SCRIPTS=\\10.36.32.38\scripts
set TSS_SCRIPTS_ASIA=\\10.36.32.49\scripts
set TSS_SCRIPTS_EUROPE=\\10.36.32.38\scripts
set TSS_PROCESS=i2
set RTNTN_DATE=0
...
set MDM_CUSTOM_DIR=\\10.36.32.45\Teradata\MDM\3.00.02\custom\pngrelease3
...
set PRETLR=\\10.36.32.49\TrilliumDeployment-RETLR\project7\batch
...
:: +---------------------------------------------------------------------------+
   ...
   ::! @set TS_PROJECT=C:\Trillium_Development\v14\development\projects\ind\cleanse
   ...
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\tranfrmr_p1.stx"    "%TS_LOGS%\p1_intranfrmr"  "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\cusparse"  "%TS_SETTINGS%\cusparse_p2.stx"    "%TS_LOGS%\p2_incusparse"  "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\drtranfrmr_p3.stx"  "%TS_LOGS%\p3_indrtrans"   "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\winkey"    "%TS_SETTINGS%\winkey_p4.stx"      "%TS_LOGS%\p4_inwinkey"    "%ERRLOG%" | (
   @"%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\tranfrmr_p5.stx"    "%TS_LOGS%\p5_intranfrmr"  "%ERRLOG%"    ))))
   ...
   @call "%HOME%\run_process.cmd"  "%TSQ_BIN%\tranfrmr"  "%TS_SETTINGS%\tranfrmr_p6.stx"  "%TS_LOGS%\p6_intranfrmr"  "%ERRLOG%"
