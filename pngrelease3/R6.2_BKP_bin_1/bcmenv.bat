...
set DB_PASSWORD=
set DB_HOST=
set JAVA_HOME="E:\Java\jdk1.8.0_73"
...
set CUSTOM=%BCM_ROOT%\custom\pngrelease3;%BCM_ROOT%\custom\pngrelease3\cfg;%BCM_ROOT%\custom\pngrelease3\cfg\properties
...
set CUSTOM_CFG=%BCM_ROOT%\custom\pngrelease3\cfg;%BCM_ROOT%\custom\pngrelease3\cfg\properties;%BCM_ROOT%\custom\pngrelease3\cfg\xservice\png;%BCM_ROOT%\custom\pngrelease3\cfg\xservice\pngrelease3\mdm_setup 
